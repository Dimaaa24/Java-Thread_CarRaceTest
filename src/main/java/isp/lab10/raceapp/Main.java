...
public class Main {
    public static void main(String[] args) {
        ...
        Car car1 = new Car("Carlitos", carPanel, semaphoreThread,rankingPanel,frame2);
        Car car2 = new Car("Carlitos2", carPanel, semaphoreThread,rankingPanel,frame2);
        Car car3 = new Car("Carlitos3", carPanel, semaphoreThread,rankingPanel,frame2);
        Car car4 = new Car("Carlitos4", carPanel, semaphoreThread,rankingPanel,frame2);
